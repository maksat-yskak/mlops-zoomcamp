...
* [Tutorial: Using Lambda with Kinesis Data Streams](https://docs.aws.amazon.com/lambda/latest/dg/with-kinesis-example.html)
...
export RUN_ID="940df4354a7e43f494a7ae59450ed964"
...
docker run -it --rm \
    ...
    -e RUN_ID="940df4354a7e43f494a7ae59450ed964" \
    -e TEST_RUN="True" \
...
```bash
REMOTE_URI="848474832112.dkr.ecr.eu-north-1.amazonaws.com/duration-model"
REMOTE_TAG="v1"
