...
kinesis_client = boto3.client('kinesis', endpoint_url=kinesis_endpoint, region_name='eu-north-1')
...
diff = DeepDiff(actual_record, expected_record, significant_digits=0)
print(f'diff={diff}')
